        ...
        <div class="widget-box">
            <div class="widget-title" style="margin: -20px 0 0">
                ...
                <div class="buttons">
                    ...
                    <a target="_blank" title="Assinar" class="btn btn-mini btn-primary" href="<?php echo site_url() ?>/mine/assinar/<?php echo $result->idOs; ?>"><i class="fas fa-pencil-alt"></i> Assinar</a>
                </div>
            </div>
